...
export const ContenidoYo: FC<ContenidoYoModel> = ({ handleClose }: ContenidoYoModel): JSX.Element => {
  return (
<>
...
<div className="  mouse">
      <div className="row">
        <div className="col-xs-1-12 cursor" data-text="yo" onClick={(e) => handleClose(e)}>
          <div data-text="yo" className="cursor" onClick={(e) => handleClose(e)}>
            <CloseIcon color="action" data-text="yo" 
